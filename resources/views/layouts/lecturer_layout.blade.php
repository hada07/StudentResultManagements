...
<body>
    @include('components.lecturer.Sidenav')
    <!-- Main content -->
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                ...
                                                <img alt="Image placeholder"
                                                    src="../../../../studentManagement/public/assets/img/theme/team-1.jpg"
                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder"
                                                    src="../../../../studentManagement/public/assets/img/theme/team-2.jpg"
                                                    class="avatar rounded-circle">
                                            </div>
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder"
                                                    src="../../../../studentManagement/public/assets/img/theme/team-3.jpg"
                                                    class="avatar rounded-circle">
                                            </div>
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder"
                                                    src="../../../../studentManagement/public/assets/img/theme/team-4.jpg"
                                                    class="avatar rounded-circle">
                                            </div>
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <img alt="Image placeholder"
                                                    src="../../../../studentManagement/public/assets/img/theme/team-5.jpg"
                                                    class="avatar rounded-circle">
                                            </div>
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                        ...
                        "   >
                                        @else
                                            <img src={{ '../../../../studentManagement/public/' . Auth::user()->avatar }} class="rounded-circle" style="
                      width: 40px;
                      height: 40px;
                  ">
                                        @endif
                            ...
                            <div class="dropdown-menu  dropdown-menu-right ">
                                ...
                                <a href={{ route('lecturer.profile') }} class="dropdown-item">
