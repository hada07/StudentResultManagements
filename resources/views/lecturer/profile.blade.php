        ...
        <div class="row">
            <div class="col-xl-4 order-xl-2">
                <div class="card card-profile">
                    ...
                    @include('lecturer.component.chooseAvatar')
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            ...
                            @include('lecturer.component.changePassword')
                          </div>
                    </div>
            ...
            <div id="edit-profile" class="col-xl-8 order-xl-1" style="display: none">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('lecturer.post.profile', Auth::user()->id) }} method="POST" role="form">
                            @csrf
