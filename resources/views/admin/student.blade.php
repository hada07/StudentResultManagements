                                ...
                                @foreach ($students as $student)
                                    <tr>
                                            ...
                                            <div class="media align-items-center">
                                              ...
                                              ">
                                                ...
                                                <div class="media-body">
                                                    <span class="name mb-0 text-sm">{{ $student->name }}
                                                    @if ($student->email)
                                        ...
                                        <td>
                                            ...
                                            @include('components.modals.students.add', ['row' => $student])
                                            @include('components.modals.students.edit', ['row' => $student])
                                            @include('components.modals.delete',['row' => $student])
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
