        ...
        <div class="row">
            <div class="col-xl-4 order-xl-2">
                <div class="card card-profile">
                    ...
                    @include('components.modals.chooseAvatar')
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            <a  class="btn btn-neutral" onclick="displayEdit();">Chỉnh sửa</a>
            ...
            <div id="edit-profile" class="col-xl-8 order-xl-1" style="display: none">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('admin.post.profile', Auth::user()->id) }} method="POST" role="form">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Tên người dùng" type="text" name="name" value="{{Auth::user()->name}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Địa chỉ" type="text" name="address" value="{{Auth::user()->address}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
